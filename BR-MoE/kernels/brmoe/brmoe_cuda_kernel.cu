 ...
 * You may obrain a copy of the License at
 *
...
#ifndef brmoe_CUDA_KERNEL_CUH
#define brmoe_CUDA_KERNEL_CUH
...
#define CALL_IF(THREAD_M_BLOCKS, THREAD_N_BLOCKS, THREAD_K_BLOCKS, GROUP_BLOCKS) \
    ...
    cudaFuncSetAttribute( \
      brmoe<THREADS, THREAD_M_BLOCKS, THREAD_N_BLOCKS, THREAD_K_BLOCKS, STAGES, GROUP_BLOCKS>, \
